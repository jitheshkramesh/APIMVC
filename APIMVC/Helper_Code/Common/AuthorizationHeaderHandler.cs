...
//namespace APIMVC.Helper_Code.Common
//{
...
namespace APIMVC.Helper_Code.Common
{
    ...
    using System.Web;
    using APIMVC.Resources.Constants;
    /// <summary>   
    ...
    public class AuthorizationHeaderHandler : DelegatingHandler
    {
        ...
        protected override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            // Verification.   
            if (request.Headers.TryGetValues(ApiInfo.APIKEY_HEADER, out apiKeyHeaderValues) && !string.IsNullOrEmpty(authorization.Parameter))
            {
            ...
            userName = decodedToken.Substring(0, decodedToken.IndexOf(":"));
                ...
                // Verification.   
                if (apiKeyHeaderValue.Equals(ApiInfo.APIKEY_VALUE) && userName.Equals(ApiInfo.USERNAME_VALUE) && password.Equals(ApiInfo.PASSWORD_VALUE))
                {
                    // Setting   
